...
while True:
    ...
    if qNo < qTotal:
        ...
        score = round((correctAnswers / qTotal) * 100, 2)  # Final score as percentage
        img, _ = cvzone.putTextRect(img, "Quiz Finished!", [250, 300], 2, 2, offset=50, border=5)
    ...
    img, _ = cvzone.putTextRect(img, f'{round((qNo/qTotal)*100)}%', [1130, 635], 2, 2, offset=16, border=None)
